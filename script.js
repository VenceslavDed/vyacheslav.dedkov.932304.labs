const leftLayoutBtn = document.querySelector('.layouts-nav_item.left');
const rightLayoutBtn = document.querySelector('.layouts-nav_item.right');
const bothLayoutBtn = document.querySelector('.layouts-nav_item.both');

const leftColumn = document.querySelector('.layouts-template_item:nth-child(1)');
const rightColumn = document.querySelector('.layouts-template_item:nth-child(2)');
